...
`;
  ...
  function isContainingBlock(elementOrCss) {
    ...
    return transformProperties.some((value3) => css[value3] ? css[value3] !== "none" : false) || (css.containerType ? css.containerType !== "normal" : false) || !webkit && (css.backdropFilter ? css.backdropFilter !== "none" : false) || !webkit && (css.filter ? css.filter !== "none" : false) || willChangeValues.some((value3) => (css.willChange || "").includes(value3)) || containValues.some((value3) => (css.contain || "").includes(value3));
  }
