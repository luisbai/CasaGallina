    ...
    <div class="container mx-auto px-4 pt-16">
        ...
        <div class="text-center border-b-2 border-green-600 pb-1.5 md:pb-2 mb-6">
            <span class="bg-green-600 px-8 py-2 text-white font-serif text-xl md:text-2xl leading-4">
                How is your donation invested?
            </span>
        </div>

        <!-- Intro text (full width, green) -->
        <div class="font-serif text-green-600 text-xl leading-6 px-4 md:px-16 pb-12 text-center">
            <strong>Casa Gallina</strong> programs favor the construction of local networks, providing access to tools for sustainable change, social participation and resilience.
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div class="relative w-full h-full">
                        ...
                        <div class="absolute inset-0 transition-opacity duration-300"
                            ...
                            <img src="{{ asset('assets/images/donaciones/gallery-1.jpg') }}"
                                 alt="Casa Gallina Programs - Image 1"
                        ...
                        <div class="absolute inset-0 transition-opacity duration-300"
                            ...
                            <img src="{{ asset('assets/images/donaciones/gallery-2.jpg') }}"
                                 alt="Casa Gallina Programs - Image 2"
                                 class="w-full h-full object-cover transition-transform duration-300"
                                 loading="lazy">
                        </div>
                        ...
                        <div class="absolute inset-0 transition-opacity duration-300"
                            ...
                            <img src="{{ asset('assets/images/donaciones/gallery-3.jpg') }}"
                                 alt="Casa Gallina Programs - Image 3"
                                 class="w-full h-full object-cover transition-transform duration-300"
                                 loading="lazy">
                        </div>
                    </div>
            ...
            <div class="w-full">
                ...
                <div class="font-serif text-gray-600 text-lg leading-6 mb-4">
                    Casa Gallina permanently develops creative activities and processes on sustainability and ecology, which involve:
                </div>
                ...
                <div class="space-y-1">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="font-serif text-gray-600 text-base leading-6">Production of educational materials</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                        <span class="font-serif text-gray-600 text-base leading-6">Training programs and educational implementation manuals for teachers</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                        <span class="font-serif text-gray-600 text-base leading-6">Workshops</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                        <span class="font-serif text-gray-600 text-base leading-6">Artistic interventions in public schools</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                        <span class="font-serif text-gray-600 text-base leading-6">Artistic projects</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                        <span class="font-serif text-gray-600 text-base leading-6">Exhibitions</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                        <span class="font-serif text-gray-600 text-base leading-6">Visual community participation projects</span>
                    </li>
                </ul>
            </div>
        </div>
