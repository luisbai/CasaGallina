                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Órden</label>
                                    <input type="text" name="orden" placeholder="Órden del Miembro en la página" class="form-control" value="{{ $miembro->orden }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tipo" class="form-control" required>
                                        ...
                                        <option value="patronos" {{ ($miembro->tipo == 'patronos' ? 'selected' : '') }}>Patronos Fundadores</option>
                                        <option value="honorarios" {{ ($miembro->tipo == 'honorarios' ? 'selected' : '') }}>Miembros Honorarios</option>
                                    </select>
                                </div>
                            </div>
                        </div>
