...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        'primary' => 'bg-forest-800 hover:bg-forest-700',
    ...
    ->add(match ($variant) { // Text color...
        ...
        'danger' => 'text-white',
        'ghost' => 'text-zinc-800',
        'subtle' => 'text-zinc-400 hover:text-zinc-800',
    })
    ...
    ->add(match ($variant) { // Grouped border treatments...
        ...
        'primary' => '[[data-flux-button-group]_&]:border-e-0 [:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-[1px] [:is([data-flux-button-group]>&:not(:first-child),_[data-flux-button-group]_:not(:first-child)>&)]:border-s-[color-mix(in_srgb,var(--color-forest-50),transparent_85%)]',
    })
