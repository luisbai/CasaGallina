...
<flux:dropdown position="bottom center" data-editor="link" class="contents">
    ...
    <div popover="manual" class="min-w-[360px] p-[5px] rounded-lg border border-zinc-200 shadow-xs bg-white">
        <div class="h-8 flex justify-between gap-2 ps-2 pe-1" data-flux-editor-link>
            ...
            <div class="flex gap-2 items-center">
                <flux:tooltip content="{{ __('Insert link') }}" class="contents">
                    <button type="button" data-editor="link:insert" class="p-0.5 text-sm font-medium text-zinc-400 rounded-sm [[data-flux-editor-link]:not(:has(input:placeholder-shown))_&:hover]:bg-zinc-200 [[data-flux-editor-link]:not(:has(input:placeholder-shown))_&]:text-zinc-800">
                ...
                <flux:tooltip content="{{ __('Unlink') }}" class="contents">
                    <button type="button" data-editor="link:unlink" class="p-0.5 text-sm font-medium text-zinc-400 rounded-sm [[data-flux-editor-link]:not(:has(input:placeholder-shown))_&:hover]:bg-zinc-200 [[data-flux-editor-link]:not(:has(input:placeholder-shown))_&]:text-zinc-800">
