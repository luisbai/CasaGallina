...
<?php else: ?>
    <div popover="manual" class="[:where(&)]:min-w-48 [&:popover-open]:flex [&:popover-open]:flex-col rounded-lg shadow-xs border border-zinc-200 bg-white p-[.3125rem]" data-flux-options>
        ...
        <ui-options class="max-h-[20rem] overflow-y-auto -me-[.3125rem] -mt-[.3125rem] pt-[.3125rem] pe-[.3125rem] -mb-[.3125rem] pb-[.3125rem]">
            ...
            <?php else: ?>
                <flux:select.empty>No se encontraron resultados</flux:select.empty>
            <?php endif; ?>
        </ui-options>
    </div>
<?php endif; ?>
